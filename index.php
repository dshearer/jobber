    ...
    <div class="banner-btn hidden-print pull-right"
      ...
      <a href="/jobber/download/" class="btn btn-lg btn-default">
        ...
        <div class="pull-right">
          Get Jobber <span class="banner-btn-details">1.2.1 | 28 Dec 2017</span>
        </div>
      </a>
    </div>
  </header>
    ...
    <section>
      <div class="row">
        <div class="col-md-6">
          ...
          <ul>
            <li class="h4">
            <a href="https://github.com/dshearer/jobber/releases/tag/v1.3.0-pr.1">v1.3.0-pr.1</a>
            <small>13 Jan 2018</small>
            </li>
            <li class="h4">
            <a href="https://github.com/dshearer/jobber/releases/tag/v1.2.1">v1.2.1</a>
